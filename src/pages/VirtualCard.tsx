...
import { ArrowLeft, CreditCard, Eye, EyeOff, Plus, Pause, Play, AlertCircle } from "lucide-react";
import { useNavigate } from "react-router-dom";
import MobileNav from "@/components/MobileNav";
import VirtualCardPoll from "@/components/VirtualCardPoll";
      ...
      <div className="p-4 space-y-4">
        ...
        <Alert className="border-warning/50 bg-warning/10">
          ...
          <AlertDescription className="text-sm">
            <strong className="font-semibold">Demo Feature:</strong> This is a prototype virtual card system. 
            Real card implementation coming soon with actual payment processing capabilities.
          </AlertDescription>
        </Alert>
