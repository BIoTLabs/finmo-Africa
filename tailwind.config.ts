  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-africa': 'var(--gradient-africa)',
      ...
      boxShadow: {
        'finmo-sm': 'var(--shadow-sm)',
        'finmo-md': 'var(--shadow-md)',
        'finmo-lg': 'var(--shadow-lg)',
        'finmo-gold': 'var(--shadow-gold)',
        'finmo-crypto': 'var(--shadow-crypto)',
      },
      transitionProperty: {
